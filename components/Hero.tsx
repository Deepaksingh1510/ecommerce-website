...
function Hero({}: Props) {
  return (
    <div className="grid md:grid-cols-4 grid-cols-2 gap-3 max-w-7xl mx-auto mt-5 px-3">
      <div className="col-span-1 md:col-span-2  hover:scale-105 duration-300 md:max-h-[600px] max-h-[300px] shadow-lg">
        <Image
      ...
      <div className="col-span-1  hover:scale-105 duration-300 md:max-h-[600px] max-h-[300px] shadow-lg">
        <Image
      ...
      <div className="md:col-span-1 col-span-2 ">
        <div className="md:grid md:grid-rows-2 flex gap-3  md:max-h-[600px] max-h-[300px]">
          <div className="row-span-1 hover:scale-105 duration-300 shadow-lg ">
            <Image
              className="object-cover h-full"
